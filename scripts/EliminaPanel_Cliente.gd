...
var ClientButtonEliminaModifica = preload("res://scenes/ClienteEliminaModifica.tscn")
...
func aggiungi_cliente(cl) -> void :
	var cliente = ClientButtonEliminaModifica.instance()
...
func _on_EliminaPanel_visibility_changed():
	set_process(visible)
